...
key_text = tk.Text(root, height=1, width=10 ,font=('Comic-sans', 20))
key_text.grid(row=1, column=0, padx=20, pady=10, columnspan=1)
input_text.grid(row=0, column=0, padx=10, pady=5, columnspan=2)

key_label = tk.Label(root, text="Enter Key >=2", font=('Comic-sans', 15))
